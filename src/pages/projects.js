...
const FeaturedProjects =({type, title, summary, img, link, github}) => {
    return (
        ...
        <Link href={link} target="_blank" className='ml-4 rounded-lg bg-black text-light py-2 px-6 font-semibold'> Visit Project</Link>
        </div>
        </div>
        </articles>
    )
...
const projects = () => {
  return (
    ...
    <main className='w-full mb-16 flex flex-col items-center justify-center'>
        ...
        <AnimatedText text="Imagination Trumps Knowledge!" className='my-4'/>
